                ...
                <div className="col-8">
                    <div className="container p-4 bg-white shadow-lg rounded">
                        ...
                        <div className="mt-4 text-secondary">
                            <p><strong>Diện tích:</strong> {detailPost?.capacity} m²</p>
                            <p><strong>Giá điện:</strong> {insertDotCommas(detailPost?.electricityPrice)}đ/kWh</p>
                            <p><strong>Giá nước:</strong> {insertDotCommas(detailPost?.waterPrice)}đ/người</p>
                            <p><strong>Tiện ích:</strong> {detailPost?.utilities}</p>
                        </div>
                        <p>{detailPost?.description}</p>
                        <div className="mt-4 rounded">
                            <p className="fw-semibold">Liên hệ:</p>
                            <p> {detailPost?.user?.userName} - {detailPost?.user?.phone} (Chính chủ)</p>
                        </div>
                    </div>
                </div>
                <div className="col-4">
                        ...
                        <div className="list-group">
                            {posts.map((post, index) => (
                                <div key={index} className="list-group-item d-flex align-items-center border-0 border-bottom pb-3">
                                    <img src={post.image} alt={post.title} className="img-thumbnail" style={{ width: "60px", height: "60px" }} />
                                    <div className="ms-3">
