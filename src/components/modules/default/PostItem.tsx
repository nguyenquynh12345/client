                ...
                data[0]?.map((item: any, index: number) => (
                    <div className="post-card" key={index}>
                        <a href={`/detail-post/${item.id}`} className="post-images">
                            <img src={"http://localhost:3333" + item.imageUrl} alt="Main" className="main-img" />
                            <div className="sub-images">
                                <img src={"http://localhost:3333" + item.imageUrl} alt="sub1" />
                                <img src={"http://localhost:3333" + item.imageUrl} alt="sub2" />
                                <img src={"http://localhost:3333" + item.imageUrl} alt="sub3" />
                                <img src={"http://localhost:3333" + item.imageUrl} alt="sub4" />
                            </div>
                        </a>
                    ...
                    <div className="post-card row" key={index}>
                        <div className="col-lg-5">
                            <a href={`/detail-post/${item.id}`} className="post-images p-0">
                                <img src={"http://localhost:3333" + item.imageUrl} alt="Main" className="w-100 h-auto mt-3" />
                            </a>
                        </div>
